...
> 更新时间：2026-08-26
> 当前代码分支：`main`（运行基线 `e7fda82`）
> 当前正式 release：`e7fda82-agenttools-20260826-r19`，Skill 默认返回校验后的本地结果地址
> 当前 Linux release：`/home/hoz2wx/radar-sim-e7fda82-agenttools-20260826-main`
> 回滚 release：`/home/hoz2wx/radar-sim-28d5b14-agenttools-20260826-main`
...
- 服务器当前 release 为 `e7fda82-agenttools-20260826-r19`（user-level systemd `active`，`NRestarts=0`，`health 200`），保留 `28d5b14-agenttools-20260826-r18` 作为回滚 release；能力 `windows 0` / `cluster 2`（executor 2 / gateway 2），合同 `16`；
- Agent Tools Bundle：`a0cc240bf3fa355d071ca91adc0fb10e72cd24c42937789b7a52d785956ce3a8`，Connector 包：`2a3862e4b18a91e083c45aca90d2e12d68248ad4e6bd1a6a2e53d9d0f75329a6`；SDK `4.0.0` / MCP `0.1.0` / Skill `0.4.2`；
