...
- 服务器当前 release 为 `9f1f070-agenttools-20260826-r20`（user-level systemd `active`，`NRestarts=0`，`health 200`），保留 `e7fda82-agenttools-20260826-r19` 作为回滚 release；能力 `windows 0` / `cluster 2`（executor 2 / gateway 2），合同 `16`；
- Agent Tools Bundle：`879340bfe9983d6d29f333f5dc4fd81a535a52d990ad10e3f4bc8ba48b73cb98`，Connector 包：`2a3862e4b18a91e083c45aca90d2e12d68248ad4e6bd1a6a2e53d9d0f75329a6`；SDK `4.0.0` / MCP `0.1.0` / Skill `0.4.2`；
